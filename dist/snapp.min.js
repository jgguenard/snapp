...
c){delete this.observers[b];break}}}})(sn||(sn={}));
...
(function(b){var a=function(a,e,d,f){this.url=e;this.method=a;this.data=d;this.options=b.extend({timeout:5E3,async:!0,dataType:"JSON",withCredentials:!1,ct:"application/x-www-form-urlencoded"},f||{});this.init()};a.prototype.prepareParams=function(a,b){var d=[],f;for(f in a)if(a.hasOwnProperty(f)){var g=b?b+"["+f+"]":f,h=a[f];d.push("object"==typeof h?this.prepareParams(h,g):encodeURIComponent(g)+"="+encodeURIComponent(h))}return d.join("&")};a.prototype.stringToJSON=function(a){return JSON.parse(a)};
...
integer:function(a){return/^-?\d+$/.test(a)}}})(sn||(sn={}));(function(b){})(sn||(sn={}));
(function(b){b.form=function(a,e){return new b.FormObject(a,e)};b.FormField={name:"FormField",init:function(a,e,d,f){var g=this;this.value=a[e]||"";b.component.observe(e,a,function(a,c){g.value=a})},update:function(a,e,d,f){var g=this;this.$form=a;this.$options=b.extend({updateEvent:"onchange",updateDebounce:0,choices:null,multiline:!1},f||{});this.$attributes=b.extend({name:e},d||{});var h=function(a){g.$form.setFieldValue(e,a.target.value);g.$form.setPristine(!1)},k;this.$attributes[this.$options.updateEvent]=
this.$options.updateDebounce?function(a){clearTimeout(k);k=setTimeout(h.bind(g,a),g.$options.updateDebounce)}:h},render:function(){var a=b.copy(this.$attributes),e=b.isEmpty(a["class"]||"")?"":a["class"]+" ";b.isEmpty(this.$form.$errors[a.name])?e+=b.config.form.validPrefix:(e+=b.config.form.invalidPrefix,this.$form.$errors[a.name].map(function(a){e+=" "+b.config.form.invalidPrefix+"-"+a.replace("_","-")}));a["class"]=e;var d=this.$options.choices?"SELECT":!0===this.$options.multiline?"TEXTAREA":
"INPUT",f=[];if("SELECT"===d)for(var g in this.$options.choices)f.push(el("option",{value:g,selected:g==this.value},this.$options.choices[g]));else"INPUT"===d?(a.type||(a.type="text"),"checkbox"===a.type?(a.checked=this.$options.value==this.value,a.value=this.$options.value):"radio"===a.type?a.checked=a.value==this.value:a.value=this.value):a.value=this.value;return el(d,a,f)}};var a=function(a,e){this.$fields=a||{};this.$errors={};this.$pristine=!0;b.isDefined(e)&&this.setFieldsValue(e)};a.prototype.serialize=
function(){var a={},b;for(b in this.$fields)a[b]=this[b];return a};a.prototype.setPristine=function(a){this.$pristine=!0===a};a.prototype.setFieldValue=function(a,b){this[a]=b;this.validateField(a,b)};a.prototype.setFieldsValue=function(a){for(var b in a)this.setFieldValue(b,a[b])};a.prototype.isValid=function(){for(var a in this.$errors)if(!b.isEmpty(this.$errors[a]))return!1;return!0};a.prototype.isPristine=function(){return this.$pristine};a.prototype.validateField=function(a,e){var d=[];if(this.$fields[a]){var f=
this.$fields[a].validation;if(!b.isEmpty(f)){b.isArray(f)||(f=[f]);for(var g in f){var h=f[g].toString().toLowerCase(),k=null,l=h.indexOf(":");0<l&&(k=h.substring(l+1).split(","),h=h.substring(0,l));b.validation[h]&&!0!==b.validation[h](e,k,a,this)&&d.push(h)}}}this.$errors[a]=d;return 0>d.length};a.prototype.field=function(a,e){return el(b.FormField,{form:this,name:a,attributes:e,options:this.$fields[a]})};b.FormObject=a})(sn||(sn={}));
