...
(function(b){b.component={lifeCycle:["init","update","render","dispose"],abortComponentRendering:function(a){a.$pendingRendering&&(b.log("Ignoring rendering request of component <"+a.definition.name+">"),clearTimeout(a.$pendingRendering))},requestComponentRendering:function(a){this.abortComponentRendering(a);a.$pendingRendering=setTimeout(function(){a.render();a.$pendingRendering=null},0)},observablePropertyChanged:function(a,e,d,f,h,g){b.log("Rendering component <"+a.definition.name+"> triggered by <"+
f.toString()+"> of scope <!"+e+">");this.requestComponentRendering(a);if(a=d.$observers?d.$observers[f]:null)for(var k in a)a[k](h,g)},observe:function(a,b,d){b.$observers||(b.$observers={});b.$observers[a]||(b.$observers[a]=[]);b.$observers[a].push(d)}};var a=function(a){this.definition=a;this.observables=[];this.scope=this.createScope()};a.prototype.createScope=function(a){var e=this,d=b.guid();return new Proxy(a||{},{get:function(a,c){var g=d+c.toString();!b.isDefined(a[c])||b.isFunction(a[c])||
"__proto__"===c||c.toString().startsWith("$")||b.inArray(e.observables,g)||(b.log("Observing property <"+c.toString()+"> of scope <"+d+">"),e.observables.push(g));return a[c]},set:function(a,c,g){var k=d+c.toString(),l=a[c];"object"!==typeof g||c.toString().startsWith("$")||(g=e.createScope(g));a[c]=g;g!==l&&!b.isFunction(g)&&b.inArray(e.observables,k)&&b.component.observablePropertyChanged(e,d,a,c,g,l);return!0}})};a.prototype.mount=function(a,e){b.log("Mounting component <"+this.definition.name+
">");var d=b.vdom.getAttribute(a,"data-sn-component");b.isDefined(d)&&d.dispose();b.vdom.setAttribute(a,"data-sn-component",this);this.container=a;for(var f in this.definition)"function"==typeof this.definition[f]&&0>b.component.lifeCycle.indexOf(f)&&(this.scope[f]=this.definition[f]);this.init(e);this.update(e);b.log("Component <"+this.definition.name+"> mounted")};a.prototype.controller=function(a,b){if(this.definition[a])if(arguments){var d=[],f;for(f in b)d.push(b[f]);this.definition[a].apply(this.scope,
d)}else this.definition[a].call(this.scope)};a.prototype.init=function(a){this.controller("init",a);b.log("Component <"+this.definition.name+"> initialized")};a.prototype.update=function(a){this.controller("update",a);b.component.requestComponentRendering(this);b.log("Component <"+this.definition.name+"> updated")};a.prototype.render=function(){if(this.definition.render){var a=this.definition.render.call(this.scope),a=b.vdom.createVirtualNode(this.container.tagName,null,a),a=b.vdom.diff(this.container,
a,!0);b.vdom.patch(a,this.scope);b.log("Component <"+this.definition.name+"> rendered")}};a.prototype.dispose=function(){b.component.abortComponentRendering(this);this.definition.dispose&&this.definition.dispose.call(this.scope);b.log("Component <"+this.definition.name+"> unmounted")};b.Component=a})(sn||(sn={}));
...
(function(b){b.validation={required:function(a){return!b.isEmpty(a)},length:function(a,b){return a.length==b[0]},minlength:function(a,b){return a.length>=b[0]},maxlength:function(a,b){return a.length<=b[0]},min:function(a,b){return!isNaN(a)&&parseFloat(a)>=b[0]},max:function(a,b){return!isNaN(a)&&parseFloat(a)<=b[0]},between:function(a,b){if(isNaN(a))return!1;var e=parseFloat(a);return e>=b[0]&&e<=b[1]},email:function(a){return/^((([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+(\.([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+)*)|((\x22)((((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(([\x01-\x08\x0b\x0c\x0e-\x1f\x7f]|\x21|[\x23-\x5b]|[\x5d-\x7e]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(\\([\x01-\x09\x0b\x0c\x0d-\x7f]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))))*(((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(\x22)))@((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))$/i.test(a)},
...
(function(b){b.form=function(a,e){return new b.FormObject(a,e)};b.FormField={name:"FormField",init:function(a,e,d,f){var h=this;this.value=a[e]||"";b.component.observe(e,a,function(a,b){h.value=a})},update:function(a,e,d,f){var h=this;this.$form=a;this.$options=b.extend({updateEvent:"onchange",updateDebounce:0,choices:null,multiline:!1},f||{});this.$attributes=b.extend({name:e},d||{});var g=function(a){h.$form.setFieldValue(e,a.target.value);h.$form.setPristine(!1)},k;this.$attributes[this.$options.updateEvent]=
this.$options.updateDebounce?function(a){clearTimeout(k);k=setTimeout(g.bind(h,a),h.$options.updateDebounce)}:g},render:function(){var a=b.copy(this.$attributes),e=b.isEmpty(a["class"]||"")?"":a["class"]+" ";b.isEmpty(this.$form.$errors[a.name])?e+=b.config.form.validPrefix:(e+=b.config.form.invalidPrefix,this.$form.$errors[a.name].map(function(a){e+=" "+b.config.form.invalidPrefix+"-"+a.replace("_","-")}));a["class"]=e;var d=this.$options.choices?"SELECT":!0===this.$options.multiline?"TEXTAREA":
"INPUT",f=[];if("SELECT"===d)for(var h in this.$options.choices)f.push(el("option",{value:h,selected:h==this.value},this.$options.choices[h]));else"INPUT"===d?(a.type||(a.type="text"),"checkbox"===a.type?(a.checked=this.$options.value==this.value,a.value=this.$options.value):"radio"===a.type?a.checked=a.value==this.value:a.value=this.value):a.value=this.value;return el(d,a,f)}};var a=function(a,e){this.$fields=a||{};this.$errors={};this.$pristine=!0;b.isDefined(e)&&this.setFieldsValue(e)};a.prototype.serialize=
...
this.$fields[a].validation;if(!b.isEmpty(f)){b.isArray(f)||(f=[f]);for(var h in f){var g=f[h].toString().toLowerCase(),k=null,l=g.indexOf(":");0<l&&(k=g.substring(l+1).split(","),g=g.substring(0,l));b.validation[g]&&!0!==b.validation[g](e,k,a,this)&&d.push(g)}}}this.$errors[a]=d;return 0>d.length};a.prototype.field=function(a,e){return el(b.FormField,{form:this,name:a,attributes:e,options:this.$fields[a]})};b.FormObject=a})(sn||(sn={}));
