...
b.childNodes[f],h=a.childNodes?a.childNodes[f]:null)if(c.isEmpty(e))d.push({type:c.vdom.operation.REMOVE_CHILD,target:a,child:a.childNodes[f]});else if(h.nodeType!==e.nodeType||h.tagName!==e.tagName){var m=(k=e.nodeType===c.vdom.node.COMPONENT)?e.tagName.name:null,p=(n=h.getAttribute("data-sn-component"))?n.definition.name:null;!k||n&&p.definition.name!==m?d.push({type:c.vdom.operation.REPLACE_CHILD,target:a,child:e,oldChild:h}):console.log(e,h)}else d=d.concat(this.diff(h,e));else c.isEmpty(e)||
...
document.createDocumentFragment();for(g=0;g<a.childNodes.length;g++){var f=a.childNodes[g];f&&d.appendChild(this.createRealNode(f,b))}e.appendChild&&e.appendChild(d)}}else a.nodeType===c.vdom.node.COMPONENT&&(e=document.createElement("DIV"),c.mount(e,a.tagName,a.attributes));return e},createVirtualNode:function(a,b,e){c.isDefined(e)||!c.isArray(b)&&c.isObject(b)&&!0!==b.$virtual||(e=b,b=null);if(c.isObject(a))a={nodeType:c.vdom.node.COMPONENT,tagName:a,attributes:b};else{var d=a.toString().toUpperCase();
c.inArray(c.vdom.allowedTagName,d)?(a={tagName:d,nodeType:c.vdom.node.ELEMENT,attributes:b},c.isArray(e)?a.childNodes=e:c.isObject(e)?a.childNodes=[e]:c.isEmpty(e)||(a.childNodes=[{nodeType:c.vdom.node.TEXT,textContent:e}])):a={nodeType:c.vdom.node.TEXT,textContent:a}}a.$virtual=!0;return a}}})(sn||(sn={}));var el=sn.vdom.createVirtualNode;
