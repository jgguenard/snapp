...
(function(f,b,c){"undefined"!=typeof module&&module.exports?module.exports=c():"function"==typeof define&&define.amd?define(c):b[f]=c();b[f]=c()})("reqwest",window,function(){function f(a,A,b){return function(){if(a._aborted)return b(a.request);if(a._timedOut)return b(a.request,"Request is aborted: timeout");if(a.request&&4==a.request.readyState){a.request.onreadystatechange=K;var c=L.exec(a.url),c=c&&c[1]||w.location.protocol;(M.test(c)?N.test(a.request.status):a.request.response)?A(a.request):b(a.request)}}}
function b(a,b){var h=b.headers||{},c;h.Accept=h.Accept||y.accept[b.type]||y.accept["*"];var e="undefined"!==typeof FormData&&b.data instanceof FormData;b.crossOrigin||h["X-Requested-With"]||(h["X-Requested-With"]=y.requestedWith);h["Content-Type"]||e||(h["Content-Type"]=b.contentType||y.contentType);for(c in h)h.hasOwnProperty(c)&&"setRequestHeader"in a&&a.setRequestHeader(c,h[c])}function c(a){z=a}function d(a,b){return a+(/\?/.test(a)?"&":"?")+b}function l(a,b,h,u){var e=O++,g=a.jsonpCallback||
"callback";a=a.jsonpCallbackName||t.getcallbackPrefix(e);var n=new RegExp("((^|\\?|&)"+g+")=([^&]+)"),f=u.match(n),k=x.createElement("script"),l=0,m=-1!==navigator.userAgent.indexOf("MSIE 10.0");f?"?"===f[3]?u=u.replace(n,"$1="+a):a=f[3]:u=d(u,g+"="+a);w[a]=c;k.type="text/javascript";k.src=u;k.async=!0;"undefined"===typeof k.onreadystatechange||m||(k.htmlFor=k.id="_reqwest_"+e);k.onload=k.onreadystatechange=function(){if(k.readyState&&"complete"!==k.readyState&&"loaded"!==k.readyState||l)return!1;
k.onload=k.onreadystatechange=null;k.onclick&&k.onclick();b(z);z=void 0;D.removeChild(k);l=1};D.appendChild(k);return{abort:function(){k.onload=k.onreadystatechange=null;h({},"Request is aborted: timeout",{});z=void 0;D.removeChild(k);l=1}}}function q(a,A){var h=this.o,c=(h.method||"GET").toUpperCase(),e="string"===typeof h?h:h.url,g=!1!==h.processData&&h.data&&"string"!==typeof h.data?t.toQueryString(h.data):h.data||null,n,S=!1;"jsonp"!=h.type&&"GET"!=c||!g||(e=d(e,g),g=null);if("jsonp"==h.type)return l(h,
a,A,e);n=h.xhr&&h.xhr(h)||P(h);n.open(c,e,!1===h.async?!1:!0);b(n,h);"undefined"!==typeof h.withCredentials&&"undefined"!==typeof n.withCredentials&&(n.withCredentials=!!h.withCredentials);w.XDomainRequest&&n instanceof w.XDomainRequest?(n.onload=a,n.onerror=A,n.onprogress=function(){},S=!0):n.onreadystatechange=f(this,a,A);h.before&&h.before(n);S?setTimeout(function(){n.send(g)},200):n.send(g);return n}function m(a,b){this.o=a;this.fn=b;v.apply(this,arguments)}function p(a){if(null!==a){if(a.match("json"))return"json";
if(a.match("javascript"))return"js";if(a.match("text"))return"html";if(a.match("xml"))return"xml"}}function v(a,b){function h(b){a.timeout&&clearTimeout(e.timeout);for(e.timeout=null;0<e._completeHandlers.length;)e._completeHandlers.shift()(b)}function c(a,b,A){a=e.request;e._responseArgs.resp=a;e._responseArgs.msg=b;e._responseArgs.t=A;for(e._erred=!0;0<e._errorHandlers.length;)e._errorHandlers.shift()(a,b,A);h(a)}this.url="string"==typeof a?a:a.url;this.timeout=null;this._fulfilled=!1;this._successHandler=
...
function(g){var d=a.type||g&&p(g.getResponseHeader("Content-Type"));g="jsonp"!==d?e.request:g;var f=F.dataFilter(g.responseText,d);try{g.responseText=f}catch(k){}if(f)switch(d){case "json":try{g=w.JSON?w.JSON.parse(f):eval("("+f+")")}catch(k){return c(g,"Could not parse JSON in response",k)}break;case "js":g=eval(f);break;case "html":g=f;break;case "xml":g=g.responseXML&&g.responseXML.parseError&&g.responseXML.parseError.errorCode&&g.responseXML.parseError.reason?null:g.responseXML}e._responseArgs.resp=
g;e._fulfilled=!0;b(g);for(e._successHandler(g);0<e._fulfillmentHandlers.length;)g=e._fulfillmentHandlers.shift()(g);h(g)},c)}function t(a,b){return new m(a,b)}function r(a){return a?a.replace(/\r?\n/g,"\r\n"):""}function E(a,b){var h=a.name,c=a.tagName.toLowerCase(),e=function(a){a&&!a.disabled&&b(h,r(a.attributes.value&&a.attributes.value.specified?a.value:a.text))},g;if(!a.disabled&&h)switch(c){case "input":/reset|button|image|file/i.test(a.type)||(e=/checkbox/i.test(a.type),c=/radio/i.test(a.type),
g=a.value,(!e&&!c||a.checked)&&b(h,r(e&&""===g?"on":g)));break;case "textarea":b(h,r(a.value));break;case "select":if("select-one"===a.type.toLowerCase())e(0<=a.selectedIndex?a.options[a.selectedIndex]:null);else for(c=0;a.length&&c<a.length;c++)a.options[c].selected&&e(a.options[c])}}function G(){var a,b;for(b=0;b<arguments.length;b++){a=arguments[b];/input|select|textarea/i.test(a.tagName)&&E(a,this);var h=["input","select","textarea"],c,e,g;for(c=0;c<h.length;c++)for(g=a[H](h[c]),e=0;e<g.length;e++)E(g[e],
this)}}function J(){return t.toQueryString(t.serializeArray.apply(null,arguments))}function Q(){var a={};G.apply(function(b,h){b in a?(a[b]&&!B(a[b])&&(a[b]=[a[b]]),a[b].push(h)):a[b]=h},arguments);return a}function I(a,b,h,c){var e,g,d=/\[\]$/;if(B(b))for(e=0;b&&e<b.length;e++)g=b[e],h||d.test(a)?c(a,g):I(a+"["+("object"===typeof g?e:"")+"]",g,h,c);else if(b&&"[object Object]"===b.toString())for(e in b)I(a+"["+e+"]",b[e],h,c);else c(a,b)}var w=this;if("document"in w)var x=document,H="getElementsByTagName",
D=x[H]("head")[0];else{var C;try{C=require("xhr2")}catch(a){throw Error("Peer dependency `xhr2` required! Please npm install xhr2");}}var M=/^http/,L=/(^\w+):\/\//,N=/^(20\d|1223)$/,O=0,R="reqwest_"+ +new Date,z,K=function(){},B="function"==typeof Array.isArray?Array.isArray:function(a){return a instanceof Array},y={contentType:"application/x-www-form-urlencoded",requestedWith:"XMLHttpRequest",accept:{"*":"text/javascript, text/html, application/xml, text/xml, */*",xml:"application/xml, text/xml",
...
}return w.XMLHttpRequest?new XMLHttpRequest:C?new C:new ActiveXObject("Microsoft.XMLHTTP")},F={dataFilter:function(a){return a}};m.prototype={abort:function(){this._aborted=!0;this.request.abort()},retry:function(){v.call(this,this.o,this.fn)},then:function(a,b){a=a||function(){};b=b||function(){};this._fulfilled?this._responseArgs.resp=a(this._responseArgs.resp):this._erred?b(this._responseArgs.resp,this._responseArgs.msg,this._responseArgs.t):(this._fulfillmentHandlers.push(a),this._errorHandlers.push(b));
return this},always:function(a){this._fulfilled||this._erred?a(this._responseArgs.resp):this._completeHandlers.push(a);return this},fail:function(a){this._erred?a(this._responseArgs.resp,this._responseArgs.msg,this._responseArgs.t):this._errorHandlers.push(a);return this},"catch":function(a){return this.fail(a)}};t.serializeArray=function(){var a=[];G.apply(function(b,h){a.push({name:b,value:h})},arguments);return a};t.serialize=function(){if(0===arguments.length)return"";var a,b=Array.prototype.slice.call(arguments,
0);(a=b.pop())&&a.nodeType&&b.push(a)&&(a=null);a&&(a=a.type);return("map"==a?Q:"array"==a?t.serializeArray:J).apply(null,b)};t.toQueryString=function(a,b){var h,c=b||!1,e=[],g=encodeURIComponent,d=function(a,b){b="function"===typeof b?b():null==b?"":b;e[e.length]=g(a)+"="+g(b)};if(B(a))for(h=0;a&&h<a.length;h++)d(a[h].name,a[h].value);else for(h in a)a.hasOwnProperty(h)&&I(h,a[h],c,d);return e.join("&").replace(/%20/g,"+")};t.getcallbackPrefix=function(){return R};t.compat=function(a,b){a&&(a.type&&
...
(function(f){f.request=function(){function b(a,b,c){return function(){if(a._aborted)return c(a.request);if(a._timedOut)return c(a.request,"Request is aborted: timeout");if(a.request&&4==a.request.readyState){a.request.onreadystatechange=K;var d=L.exec(a.url),d=d&&d[1]||x.location.protocol;(M.test(d)?N.test(a.request.status):a.request.response)?b(a.request):c(a.request)}}}function c(a,b){var c=b.headers||{},d;c.Accept=c.Accept||y.accept[b.type]||y.accept["*"];var e="undefined"!==typeof FormData&&b.data instanceof
FormData;b.crossOrigin||c["X-Requested-With"]||(c["X-Requested-With"]=y.requestedWith);c["Content-Type"]||e||(c["Content-Type"]=b.contentType||y.contentType);for(d in c)c.hasOwnProperty(d)&&"setRequestHeader"in a&&a.setRequestHeader(d,c[d])}function d(a){z=a}function f(a,b){return a+(/\?/.test(a)?"&":"?")+b}function q(a,b,c,u){var e=O++,g=a.jsonpCallback||"callback";a=a.jsonpCallbackName||r.getcallbackPrefix(e);var n=new RegExp("((^|\\?|&)"+g+")=([^&]+)"),m=u.match(n),k=H.createElement("script"),
p=0,q=-1!==navigator.userAgent.indexOf("MSIE 10.0");m?"?"===m[3]?u=u.replace(n,"$1="+a):a=m[3]:u=f(u,g+"="+a);x[a]=d;k.type="text/javascript";k.src=u;k.async=!0;"undefined"===typeof k.onreadystatechange||q||(k.htmlFor=k.id="_reqwest_"+e);k.onload=k.onreadystatechange=function(){if(k.readyState&&"complete"!==k.readyState&&"loaded"!==k.readyState||p)return!1;k.onload=k.onreadystatechange=null;k.onclick&&k.onclick();b(z);z=void 0;C.removeChild(k);p=1};C.appendChild(k);return{abort:function(){k.onload=
k.onreadystatechange=null;c({},"Request is aborted: timeout",{});z=void 0;C.removeChild(k);p=1}}}function m(a,d){var h=this.o,u=(h.method||"GET").toUpperCase(),e="string"===typeof h?h:h.url,g=!1!==h.processData&&h.data&&"string"!==typeof h.data?r.toQueryString(h.data):h.data||null,n,m=!1;"jsonp"!=h.type&&"GET"!=u||!g||(e=f(e,g),g=null);if("jsonp"==h.type)return q(h,a,d,e);n=h.xhr&&h.xhr(h)||P(h);n.open(u,e,!1===h.async?!1:!0);c(n,h);"undefined"!==typeof h.withCredentials&&"undefined"!==typeof n.withCredentials&&
(n.withCredentials=!!h.withCredentials);x.XDomainRequest&&n instanceof x.XDomainRequest?(n.onload=a,n.onerror=d,n.onprogress=function(){},m=!0):n.onreadystatechange=b(this,a,d);h.before&&h.before(n);m?setTimeout(function(){n.send(g)},200):n.send(g);return n}function p(a,b){this.o=a;this.fn=b;t.apply(this,arguments)}function v(a){if(null!==a){if(a.match("json"))return"json";if(a.match("javascript"))return"js";if(a.match("text"))return"html";if(a.match("xml"))return"xml"}}function t(a,b){function c(b){a.timeout&&
...
var e=this;b=b||function(){};a.timeout&&(this.timeout=setTimeout(function(){e._timedOut=!0;e.request.abort()},a.timeout));a.success&&(this._successHandler=function(){a.success.apply(a,arguments)});a.error&&this._errorHandlers.push(function(){a.error.apply(a,arguments)});a.complete&&this._completeHandlers.push(function(){a.complete.apply(a,arguments)});this.request=m.call(this,function(g){var f=a.type||g&&v(g.getResponseHeader("Content-Type"));g="jsonp"!==f?e.request:g;var l=F.dataFilter(g.responseText,
f);try{g.responseText=l}catch(k){}if(l)switch(f){case "json":try{g=x.JSON?x.JSON.parse(l):eval("("+l+")")}catch(k){return d(g,"Could not parse JSON in response",k)}break;case "js":g=eval(l);break;case "html":g=l;break;case "xml":g=g.responseXML&&g.responseXML.parseError&&g.responseXML.parseError.errorCode&&g.responseXML.parseError.reason?null:g.responseXML}e._responseArgs.resp=g;e._fulfilled=!0;b(g);for(e._successHandler(g);0<e._fulfillmentHandlers.length;)g=e._fulfillmentHandlers.shift()(g);c(g)},
d)}function r(a,b){return new p(a,b)}function E(a){return a?a.replace(/\r?\n/g,"\r\n"):""}function G(a,b){var c=a.name,d=a.tagName.toLowerCase(),e=function(a){a&&!a.disabled&&b(c,E(a.attributes.value&&a.attributes.value.specified?a.value:a.text))},g;if(!a.disabled&&c)switch(d){case "input":/reset|button|image|file/i.test(a.type)||(e=/checkbox/i.test(a.type),d=/radio/i.test(a.type),g=a.value,(!e&&!d||a.checked)&&b(c,E(e&&""===g?"on":g)));break;case "textarea":b(c,E(a.value));break;case "select":if("select-one"===
a.type.toLowerCase())e(0<=a.selectedIndex?a.options[a.selectedIndex]:null);else for(d=0;a.length&&d<a.length;d++)a.options[d].selected&&e(a.options[d])}}function J(){var a,b;for(b=0;b<arguments.length;b++){a=arguments[b];/input|select|textarea/i.test(a.tagName)&&G(a,this);var c=["input","select","textarea"],d,e,g;for(d=0;d<c.length;d++)for(g=a[D](c[d]),e=0;e<g.length;e++)G(g[e],this)}}function Q(){return r.toQueryString(r.serializeArray.apply(null,arguments))}function I(){var a={};J.apply(function(b,
c){b in a?(a[b]&&!B(a[b])&&(a[b]=[a[b]]),a[b].push(c)):a[b]=c},arguments);return a}function w(a,b,c,d){var e,g,f=/\[\]$/;if(B(b))for(e=0;b&&e<b.length;e++)g=b[e],c||f.test(a)?d(a,g):w(a+"["+("object"===typeof g?e:"")+"]",g,c,d);else if(b&&"[object Object]"===b.toString())for(e in b)w(a+"["+e+"]",b[e],c,d);else d(a,b)}var x=this;if("document"in x)var H=document,D="getElementsByTagName",C=H[D]("head")[0];else throw Error("Peer dependency `xhr2` required! Please npm install xhr2");var M=/^http/,L=/(^\w+):\/\//,
N=/^(20\d|1223)$/,O=0,R="reqwest_"+ +new Date,z,K=function(){},B="function"==typeof Array.isArray?Array.isArray:function(a){return a instanceof Array},y={contentType:"application/x-www-form-urlencoded",requestedWith:"XMLHttpRequest",accept:{"*":"text/javascript, text/html, application/xml, text/xml, */*",xml:"application/xml, text/xml",html:"text/html",text:"text/plain",json:"application/json, text/javascript",js:"application/javascript, text/javascript"}},P=function(a){if(!0===a.crossOrigin){var b=
