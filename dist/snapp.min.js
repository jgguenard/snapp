...
(function(b){b.component={lifeCycle:["init","update","render","dispose"],abortComponentRendering:function(c){c.$pendingRendering&&(b.log("Ignoring rendering request of component <"+c.definition.name+">"),clearTimeout(c.$pendingRendering))},requestComponentRendering:function(c){this.abortComponentRendering(c);c.$pendingRendering=setTimeout(function(){c.render();c.$pendingRendering=null},0)},observablePropertyChanged:function(c,a,d,f,h,g){b.log("Rendering component <"+c.definition.name+"> triggered by <"+
f.toString()+"> of scope <!"+a+">");this.requestComponentRendering(c);if(c=d.$observers?d.$observers[f]:null)for(var k in c)c[k](h,g)},observe:function(c,a,b){a.$observers||(a.$observers={});a.$observers[c]||(a.$observers[c]=[]);a.$observers[c].push(b)}};var a=function(a){this.definition=a;this.observables=[];this.scope=this.createScope()};a.prototype.createScope=function(a){var e=this,d=b.guid();return new Proxy(a||{},{get:function(a,c){var g=d+c.toString();!b.isDefined(a[c])||b.isFunction(a[c])||
...
(function(b){b.form=function(a,e){return new b.FormObject(a,e)};b.FormField={name:"FormField",init:function(a,e,d,f){var h=this;this.value=a[e]||"";b.component.observe(e,a,function(a,c){h.value=a})},update:function(a,e,d,f){var h=this;this.$form=a;this.$options=b.extend({updateEvent:"onchange",updateDebounce:0,choices:null,multiline:!1},f||{});this.$attributes=b.extend({name:e},d||{});var g=function(a){h.$form.setFieldValue(e,a.target.value);h.$form.setPristine(!1)},k;this.$attributes[this.$options.updateEvent]=
...
this.$fields[a].validation;if(!b.isEmpty(f)){b.isArray(f)||(f=[f]);for(var h in f){var g=f[h];!0!==b.validation[g](e)&&d.push(g)}}}this.$errors[a]=d;return 0>d.length};a.prototype.field=function(a,e){return el(b.FormField,{form:this,name:a,attributes:e,options:this.$fields[a]})};b.FormObject=a})(sn||(sn={}));
